...
<Frame>
  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/mode-toggle-light.png" alt="Mode toggle in the Mintlify Web Editor" className="block dark:hidden" />

  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/mode-toggle-dark.png" alt="Mode toggle in the Mintlify Web Editor" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/markdown-mode-light.png" alt="Markdown editing mode in the Mintlify Web Editor" className="block dark:hidden" />

  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/markdown-mode-dark.png" alt="Markdown editing mode in the Mintlify Web Editor" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/component-menu-light.png" alt="Component menu in the Mintlify Web Editor" className="block dark:hidden" />

  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/component-menu-dark.png" alt="Component menu in the Mintlify Web Editor" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/publish-flow-light.png" alt="Publishing flow in the Mintlify Web Editor" className="block dark:hidden" />

  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/publish-flow-dark.png" alt="Publishing flow in the Mintlify Web Editor" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/pull-request-light.png" alt="Pull request creation in the Mintlify Web Editor" className="block dark:hidden" />

  <img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/editor/pull-request-dark.png" alt="Pull request creation in the Mintlify Web Editor" className="hidden dark:block" />
</Frame>
